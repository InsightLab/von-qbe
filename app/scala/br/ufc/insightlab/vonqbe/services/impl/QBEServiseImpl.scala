package scala.br.ufc.insightlab.vonqbe.services.impl

import java.util

import play.api.Logger
import scala.br.ufc.insightlab.vonqbe.repository.QBERepository

import scala.collection.mutable
import scala.concurrent.Future

class QBEServiseImpl (ntPath : String, qbeRepository : QBERepository) extends scala.br.ufc.insightlab.vonqbe.services.QBEService{
